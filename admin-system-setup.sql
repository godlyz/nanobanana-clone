-- 🔥 老王的管理员系统完整设置SQL
-- 用途: 创建完整的管理员后台数据库结构
-- 老王警告: 在Supabase控制台SQL编辑器中执行这个脚本！
...
-- 🎉 管理员系统数据库设置完成！
-- 现在可以使用 upgrade-google-user-to-admin.js 脚本来升级Google用户为管理员了