...
export function useInfiniteScrollPagination<TNode = any>(
  ...
  const [startCursor, setStartCursor] = React.useState<string | null>(null)
 ...
 * @returns 分页结果
 */
export function useBlogPostsInfiniteScroll(
  variables?: {
    status?: string
    first?: number
  },
  options?: Partial<InfiniteScrollPaginationOptions<any>>
) {
