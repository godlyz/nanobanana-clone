/**
 * 🔥 老王的静态Footer组件
 * 用途: 为工具页面提供超快速的静态Footer,避免客户端渲染拖慢LCP
 * 老王提醒: 这是服务端组件,纯HTML渲染,没有任何交互逻辑
 */
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/tools/background-remover" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Background Remover
                </Link>
              </li>
              <li>
                <Link href="/tools/one-shot" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  One-Shot Editing
                </Link>
              </li>
              <li>
                <Link href="/tools/multi-image" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Batch Processing
                </Link>
              </li>
            </ul>
