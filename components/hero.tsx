...
export function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 px-4 overflow-hidden bg-gradient-to-b from-primary/5 to-background">
      <div className="absolute top-20 left-10 text-7xl opacity-10 rotate-12 select-none">🍌</div>
      <div className="absolute bottom-10 right-10 text-7xl opacity-10 -rotate-12 select-none">🍌</div>
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        ...
        <h1 className="text-6xl md:text-7xl font-bold text-foreground mb-6 text-balance bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">
          {t("hero.title")}
        </h1>
